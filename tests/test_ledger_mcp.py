...
class LedgerMcpReadTierTests(unittest.TestCase):
    ...
    def test_cash_flow_forecast_matches_direct_api(self):
        body = self.call("ledger_cash_flow_forecast", period="2026-06")
        self.assertEqual(self.direct("/api/analytics/cash-flow-forecast",
                                     period="2026-06"), body)
        self.assertEqual("2026-06", body["period"])

    def test_goal_pace_matches_direct_api(self):
        body = self.call("ledger_goal_pace", as_of="2026-07-19")
    ...
    def test_pantry_pulse_matches_direct_api(self):
        ...
        self.assertEqual(
            {"list_count", "list_total", "priced_count", "unpriced_count", "list",
             "due_soon", "on_the_way", "stale_staples", "stale_shopping_items",
