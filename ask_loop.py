...
def system_prompt(period):
    ...
    return (
        ...
        "remove one they no longer want (ledger_archive_item); or teach Ledger "
        "how a staple shows up on the bank feed so it spots restocks "
        "(ledger_set_item_match). Handle whatever they say — 'we're out of "
        "coffee', 'add paper towels', 'stop tracking napkins', 'match dog food to "
        "chewy', 'what do we need?'. Say plainly what you did; it's all reversible "
        "and logged.\n"
