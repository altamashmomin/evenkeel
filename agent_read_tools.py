...
READ_TOOLS = [
    ...
    },
    {
        ...
        "description":
            ...
            "of staples running low, restock_suggestions (low/out staples "
            ...
            "(change_bp: recent restocks vs earlier, in basis points), trip_plan "
            "(the list plus due_soon: stocked staples the forecast expects to run "
            "out, each with predicted_date, store, and typical cost — 'going "
            "anyway? also grab…'; judge 'soon' against today's date yourself), "
            "and trip_closure (one recent purchase that plausibly restocked 2+ "
            "low/out staples — confirm with ledger_restock_items, never assume). "
            "Use this for "
